            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input value="{{ old('valor_minimo',$servico->valor_minimo ?? '')  }}" type="input" requered
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input value="{{ old('quantidade_horas', $servico->quantidade_horas ?? '' )}}" type="input"
                            requered class="form-control" name="quantidade_horas" data-mask="0" id="quantidade_horas"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input value="{{ old('porcentagem',$servico->porcentagem ?? '' ) }}" type="input" requered
                            class="form-control" name="porcentagem" data-mask="00" id="porcentagem"
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input value="{{ old('valor_quarto ',$servico->valor_quarto ?? '' )  }}" type="input" requered
                            class="form-control" name="valor_quarto" data-mask="#.##0,00" data-mask-reverse="true"
                            id="valor_quarto" placeholder="Valor por quarto">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="horas_quarto">Quantidade de Horas por quarto</label>
                        <input value="{{ old('horas_quarto',$servico->horas_quarto ?? '')  }}" type="input" requered
                            class="form-control" name="horas_quarto" data-mask="0" id="horas_quarto"
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input value="{{ old('valor_sala',$servico->valor_sala ?? '')  }}" type="input" requered
                            class="form-control" name="valor_sala" data-mask="#.##0,00" data-mask-reverse="true"
                            id="valor_sala" placeholder="Valor por sala">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="horas_sala">Quantidade de horas por sala</label>
                        <input value="{{ old('horas_sala',$servico->horas_sala ?? '')  }}" type="input" requered
                            class="form-control" name="horas_sala" data-mask="0" id="horas_sala"
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input value="{{ old('valor_banheiro',$servico->valor_banheiro ?? '' ) }}" type="input" requered
                            class="form-control" name="valor_banheiro" data-mask="#.##0,00" data-mask-reverse="true"
                            id="valor_banheiro" placeholder="Valor por banheiro">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="horas_banheiro">Quantidade de horas por banheiro</label>
                        <input value="{{ old('horas_banheiro',$servico->horas_banheiro ?? '')  }}" type="input" requered
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input value="{{ old('valor_cozinha', $servico->valor_cozinha ?? '' ) }}" type="input" requered
                            class="form-control" name="valor_cozinha" data-mask="#.##0,00" data-mask-reverse="true"
                            id="valor_cozinha" placeholder="Valor por cozinha">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="horas_cozinha">Quantidade de horas por cozinha</label>
                        <input value="{{ old('horas_cozinha',$servico->horas_cozinha ?? '')  }}" type="input" requered
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input value="{{ old('valor_quintal', $servico->valor_quintal ?? '') }}" type="input" requered
                            class="form-control" name="valor_quintal" data-mask="#.##0,00" data-mask-reverse="true"
                            id="valor_quintal" placeholder="Valor por quintal">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="horas_quintal">Quantidade de horas por quintal</label>
                        <input value="{{ old('horas_quintal',$servico->horas_quintal ?? '')  }}" type="input" requered
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input value="{{ old('valor_outros',$servico->valor_outros ?? '')  }}" type="input" requered
                            class="form-control" name="valor_outros" data-mask="#.##0,00" data-mask-reverse="true"
                            id="valor_outros" placeholder="Valor por outros">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
